...
///////////////////////////////////////////////////////////////////////////////
/******************** Control I/O *****************************/
#define rfCE_Low()                     RFCE2LOW()
#define rfCE_High()                    RFCE2HIGH()

#define spiCSOn()                      RFCSS2LOW()
#define spiCSOff()                     RFCSS2HIGH()

#define rfIrqIsHigh()                  ((RFIRQPORT->IDR&RFIRQBIT) != 0)  
////////////////////////////////////////////////////////////////////////////////
//                    以下为声明部分，不建议修改                              //
////////////////////////////////////////////////////////////////////////////////
...
#define         DEFAULT_CHANNEL                100				//初始化时的频率： 2478 MHz           
#define         PAYLOAD_WIDTH                  32				//Payload宽度：     8bytes				
#define         TRANSMIT_TYPE                 TRANS_ENHANCE_MODE 		//使用增强型模式           TRANS_BURST_MODE    TRANS_ENHANCE_MODE
#define         DATA_RATE                      DR_250K                            //通信速率2Mbps            DR_2M    DR_1M
